 ...
 */
public class DLTNGTestTemplate implements CompiledTemplate
{
@Override
...
//set 2:2
context.setBinding("adCampaignTemplate","DLTNGTest.template.adcampaign.dlt");
//load 3:2
context.load("LOAD_INIT", "de.s42.dlt.DLTNGTest$LoadInit", new Object[] {context.resolveBinding("name")});
//set 4:2
context.setBinding( new String[] { "user", "firstName"}, new Object[] { "Stefan"});
//assert 10:2
assert (boolean)context.resolveBinding(new String[] {"user"}, new String[] {"exists"}) : "user has to be set" + " - " + 10 + ":" + 2 + " in 'DLTNGTest.template.dlt'";
//set 11:2
